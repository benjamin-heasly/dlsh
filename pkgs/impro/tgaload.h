...
#define TGA_GL_RGB             1
#define TGA_GL_RGBA            2
#define TGA_GL_ALPHA           3
#define TGA_GL_LUMINANCE       4
...
/* 'Public' functions */
int   tgaLoad         ( char *file_name, image_t *p, tgaFLAG mode );
void tgaFree ( image_t *p );
int tga_getImageDims(char *file_name, int *, int *, int *);
